  ...
  <body class="v1">
    <div class="container1">
      <div class="forms-container1">
        <!-- <button class="nn">logo</button> -->
        <div class="signin-signup">
          <form action="#" class="sign-in-form" @click.prevent>
            <!-- <p>sign in</p> -->
          ...
          <!-- <p>sign Up</p> -->
          <form action="#" class="sign-up-form" @click.prevent>
...
export default {
  ...
  methods: {
    login(type) {
      if (type === "signUp") {
        document.querySelector(".container1").classList.add("sign-up-mode");
      } else {
        document.querySelector(".container1").classList.remove("sign-up-mode");
      }
    },
    signIn() {
      this.v$.$validate();
