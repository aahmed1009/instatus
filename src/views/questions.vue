<template>
          ...
          <div class="w-full sm:w-10/12 md:w-1/2 my-1">
            ...
            <ul class="flex flex-col">
              ...
              <li class="bg-white my-2 shadow-lg" x-data="accordion(2)">
                ...
                >
                  <p class="p-3 text-gray-900">
                    Once shipped, you’ll get a confirmation email that includes
                    a tracking number and additional information regarding
                    tracking your order.
                  </p>
                </div>
              </li>
              ...
              <li class="bg-white my-2 shadow-lg" x-data="accordion(4)">
                ...
                >
                  <p class="p-3 text-gray-900">
                    ...
                    apply any changes to it. If you are unhappy with your order
                    when it arrives, please contact us for any changes you may
                    require.
                  </p>
                </div>
              </li>
  ...
  <template class="stats">
    <section class="p-6 dark:bg-gray-800 dark:text-gray-100">
      ...
      <div
        class="container flex flex-wrap justify-center mx-auto dark:text-gray-400"
      >
        <div
